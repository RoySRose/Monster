...
import prebot.common.debugger.UxColor;
...
//		}
    ...
    private void drawExpectedResource() {
        ...
        Monster.Broodwar.drawTextScreen(10, y += 10, "frame ==== " + Monster.Broodwar.getFrameCount());
    ...
    private int drawCalculation(int x, int y) {
        y += 10;
        Monster.Broodwar.drawTextScreen(x, y += 10, UxColor.CHAR_RED + "Decision : " + AttackDecisionMaker.Instance().decision + ", phase3: " + StrategyAnalyseManager.Instance().getPhase() + ", strategy" + StrategyIdea.currentStrategy.name());
    ...
    private void drawTimer() {
        ...
        Monster.Broodwar.drawTextScreen(170, 353, battleColor + StrategyIdea.mainSquadMode.toString() + ": " + TimeUtils.framesToTimeString(TimeUtils.elapsedFrames()) + "(" + TimeUtils.elapsedFrames() + ")");
    ...
    private void drawEnemyBuildTimer() {
        ...
        int y = 20;
        Monster.Broodwar.drawTextScreen(20, y += 15, "engine Build Frame : " + TimeUtils.framesToTimeString(StrategyIdea.engineeringBayBuildStartFrame));
        Monster.Broodwar.drawTextScreen(20, y += 15, "turret Build Frame : " + TimeUtils.framesToTimeString(StrategyIdea.turretBuildStartFrame));
        Monster.Broodwar.drawTextScreen(20, y += 15, "turret Need  Frame : " + TimeUtils.framesToTimeString(StrategyIdea.turretNeedFrame));
        y += 15;

        Monster.Broodwar.drawTextScreen(20, y += 15, "academy Build Frame : " + TimeUtils.framesToTimeString(StrategyIdea.academyFrame));
        Monster.Broodwar.drawTextScreen(20, y += 15, "comsat Build Frame : " + TimeUtils.framesToTimeString(StrategyIdea.academyFrame + UnitType.Terran_Academy.buildTime()));
        y += 15;
...
//		Monster.Broodwar.drawTextScreen(x + 50, y, "" + white + Monster.Broodwar.getFrameCount());
//		Monster.Broodwar.drawTextScreen(x + 90, y, "" + white + (int)(Monster.Broodwar.getFrameCount() / (23.8 * 60)) + ":" + (int)((int)(Monster.Broodwar.getFrameCount() / 23.8) % 60));
//		y += 11;


        Monster.Broodwar.drawTextScreen(x, y, UxColor.CHAR_WHITE + "Current Strategy : ");
        Monster.Broodwar.drawTextScreen(x + 100, y, "" + UxColor.CHAR_WHITE + StrategyIdea.currentStrategy.name());
        y += 11;
...
//        }
        ...
        Monster.Broodwar.drawTextScreen(x, y, "" + UxColor.CHAR_WHITE + StrategyIdea.factoryRatio + ", selected=" + factorySelected);
        y += 11;

        Monster.Broodwar.drawTextScreen(x, y, UxColor.CHAR_WHITE + "Wraith Count : ");
        Monster.Broodwar.drawTextScreen(x + 75, y, "" + UxColor.CHAR_WHITE + StrategyIdea.wraithCount + " / " + UnitUtils.getUnitCount(CommonCode.UnitFindRange.COMPLETE, UnitType.Terran_Wraith));
        y += 11;

        Monster.Broodwar.drawTextScreen(x, y, UxColor.CHAR_WHITE + "Valkyrie Count : ");
        Monster.Broodwar.drawTextScreen(x + 75, y, "" + UxColor.CHAR_WHITE + StrategyIdea.valkyrieCount + " / " + UnitUtils.getUnitCount(CommonCode.UnitFindRange.COMPLETE, UnitType.Terran_Valkyrie));
        y += 11;
    ...
    public void drawUnitExtendedInformationOnMap() {
        ...
        if (InformationManager.Instance().getUnitData(InformationManager.Instance().enemyPlayer) != null) {
            ...
            // C++ : for (final Unit kv : InformationManager.Instance().getUnitData(Monster.game.enemy()).getUnits())
            while (it.hasNext()) {
    ...
    public void drawUnitStatisticsOnScreen1(int x, int y) {
        ...
        // 아군이 입은 피해 누적값
        Monster.Broodwar.drawTextScreen(x, currentY, UxColor.CHAR_WHITE + " Self Loss:" + UxColor.CHAR_WHITE + " Minerals: " + UxColor.CHAR_BROWN + InformationManager.Instance().getUnitData(Monster.Broodwar.self()).getMineralsLost() + UxColor.CHAR_WHITE + " Gas: " + UxColor.CHAR_RED + InformationManager.Instance().getUnitData(Monster.Broodwar.self()).getGasLost());
        currentY += 10;
    ...
    public void drawUnitStatisticsOnScreen2(int x, int y) {
        ...
        Monster.Broodwar.drawTextScreen(x, currentY, UxColor.CHAR_WHITE + " UNIT NAME");
        ...
        Monster.Broodwar.drawTextScreen(x + 85, currentY, UxColor.CHAR_WHITE + " Alive");
...
//				int numDeadUnits = InformationManager.Instance().getUnitData(InformationManager.Instance().enemyPlayer).getNumDeadUnits(tempUnitName);
                ...
                if (numUnits > 0) {
                    Monster.Broodwar.drawTextScreen(x, currentY + 30 + ((yspace) * 10), displayname);
//					Monster.Broodwar.drawTextScreen(x + 120, currentY + 30 + ((yspace)* 10), "" + numCreatedUnits);
//					Monster.Broodwar.drawTextScreen(x + 160, currentY + 30 + ((yspace)* 10), "" + numDeadUnits);
                    Monster.Broodwar.drawTextScreen(x + 110, currentY + 30 + ((yspace) * 10), "" + numUnits);
                    yspace++;
                }
            }
        }
...
//				}
    ...
    private void drawStrategy() {
        ...
        Monster.Broodwar.drawTextScreen(20, y += 12, UxColor.CHAR_YELLOW + "FAC RATIO : " + StrategyIdea.factoryRatio + ".. (" + UnitUtils.myFactoryUnitSupplyCount() + ")");
        Monster.Broodwar.drawTextScreen(20, y += 12, UxColor.CHAR_YELLOW + "UPGRADE   : " + upgradeString);
        Monster.Broodwar.drawTextScreen(20, y += 12, UxColor.CHAR_YELLOW + "MARINE CNT : " + StrategyIdea.marineCount);
        Monster.Broodwar.drawTextScreen(20, y += 12, UxColor.CHAR_YELLOW + "ADDON     : " + StrategyIdea.addOnOption);
        Monster.Broodwar.drawTextScreen(20, y += 12, UxColor.CHAR_YELLOW + "EXPANSION : " + StrategyIdea.expansionOption);
        Monster.Broodwar.drawTextScreen(20, y += 12, UxColor.CHAR_YELLOW + "WRAITH CNT : " + StrategyIdea.wraithCount);
        Monster.Broodwar.drawTextScreen(20, y += 12, UxColor.CHAR_YELLOW + "VALKYRIE CNT : " + StrategyIdea.valkyrieCount);
    ...
    private void drawAirForceInformation() {
        ...
        Monster.Broodwar.drawTextScreen(20, y += 15, "wraith count=" + StrategyIdea.wraithCount);
    }

    private void drawVulturePolicy() {
        int y = 10;
        Monster.Broodwar.drawTextScreen(400, y += 15, "[vulture policy]");
        Monster.Broodwar.drawTextScreen(400, y += 15, "checkerMaxNumber=" + StrategyIdea.checkerMaxNumber);
        Monster.Broodwar.drawTextScreen(400, y += 15, "spiderMineNumberPerPosition=" + StrategyIdea.spiderMineNumberPerPosition);
        Monster.Broodwar.drawTextScreen(400, y += 15, "spiderMineNumberPerGoodPosition=" + StrategyIdea.spiderMineNumberPerGoodPosition);
        Monster.Broodwar.drawTextScreen(400, y += 15, "watcherMinePositionLevel=" + StrategyIdea.watcherMinePositionLevel);
    }

    private void drawEnemyBaseToBaseTime() {
        int y = 0;
        Monster.Broodwar.drawTextScreen(10, y += 15, "campPosition : " + StrategyIdea.campPosition + " / " + StrategyIdea.campType);
        Monster.Broodwar.drawTextScreen(10, y += 15, "mainPosition : " + StrategyIdea.mainPosition);
        Monster.Broodwar.drawTextScreen(10, y += 15, "watcherPosition : " + StrategyIdea.watcherPosition);
        Monster.Broodwar.drawTextScreen(10, y += 15, "mainSquadCenter : " + StrategyIdea.mainSquadCenter);
        Monster.Broodwar.drawTextScreen(10, y += 15, "enemyGroundSquadPosition : " + StrategyIdea.nearGroundEnemyPosition + " / " + StrategyIdea.enemyUnitStatus);
        Monster.Broodwar.drawTextScreen(10, y += 15, "enemyAirSquadPosition : " + StrategyIdea.nearAirEnemyPosition);
        Monster.Broodwar.drawTextScreen(10, y += 15, "enemyDropEnemyPosition : " + StrategyIdea.dropEnemyPosition);
        ...
        Monster.Broodwar.drawTextScreen(10, y += 15, "enemyBase : " + enemyBasePosition);
        Monster.Broodwar.drawTextScreen(10, y += 15, "enemyFirstExpansion : " + enemyExpansionPosition);

        if (StrategyIdea.enemyBaseExpected != null) {
            Monster.Broodwar.drawTextScreen(10, y += 15, "enemyBase (Expect) : " + StrategyIdea.enemyBaseExpected.getPosition());
        }
...
//		}
    ...
    private void drawPositionInformation() {
        ...
        if (StrategyIdea.mainSquadLeaderPosition != null) {
            Monster.Broodwar.drawTextMap(PositionUtils.positionAdjsuted(StrategyIdea.mainSquadLeaderPosition, 0, -20), UxColor.CHAR_WHITE + "V");
        }
        if (StrategyIdea.campPosition.equals(StrategyIdea.mainPosition)) {
            Monster.Broodwar.drawTextMap(StrategyIdea.campPosition, UxColor.CHAR_ORANGE + "camp & main");
        } else {
            if (StrategyIdea.campPosition != null) {
                Monster.Broodwar.drawTextMap(StrategyIdea.campPosition, UxColor.CHAR_YELLOW + "camp");
            }
            if (StrategyIdea.mainPosition != null) {
                Monster.Broodwar.drawTextMap(PositionUtils.positionAdjsuted(StrategyIdea.mainPosition, 0, -10), UxColor.CHAR_RED + "main");
            }
        }
        if (StrategyIdea.campPositionSiege != null) {
            Monster.Broodwar.drawTextMap(StrategyIdea.campPositionSiege, UxColor.CHAR_YELLOW + "camp (siege)");
        }
        if (StrategyIdea.watcherPosition != null) {
            Monster.Broodwar.drawTextMap(PositionUtils.positionAdjsuted(StrategyIdea.watcherPosition, 0, -20), UxColor.CHAR_BLUE + "watcherPos");
        }
        if (StrategyIdea.mainSquadCenter != null) {
            Monster.Broodwar.drawTextMap(StrategyIdea.mainSquadCenter, "mainSqCntr");
            Monster.Broodwar.drawCircleMap(StrategyIdea.mainSquadCenter.getX(), StrategyIdea.mainSquadCenter.getY(), StrategyIdea.mainSquadCoverRadius, Color.Cyan);
        }
        if (StrategyIdea.nearGroundEnemyPosition != null) {
            Monster.Broodwar.drawTextMap(StrategyIdea.nearGroundEnemyPosition, UxColor.CHAR_RED + "nearEnemySq(Ground)");
            Monster.Broodwar.drawCircleMap(StrategyIdea.nearGroundEnemyPosition, 150, Color.Red);
        }
        if (StrategyIdea.nearAirEnemyPosition != null) {
            Monster.Broodwar.drawTextMap(StrategyIdea.nearAirEnemyPosition, UxColor.CHAR_RED + "nearEnemySq(Air)");
            Monster.Broodwar.drawCircleMap(StrategyIdea.nearAirEnemyPosition, 150, Color.Red);
        }
        if (StrategyIdea.dropEnemyPosition != null) {
            Monster.Broodwar.drawTextMap(StrategyIdea.dropEnemyPosition, UxColor.CHAR_RED + "dropEnemySq");
            Monster.Broodwar.drawCircleMap(StrategyIdea.dropEnemyPosition, 150, Color.Red);
        }
        if (StrategyIdea.totalEnemyCneterPosition != null) {
            Monster.Broodwar.drawTextMap(StrategyIdea.totalEnemyCneterPosition, "totalEnemySq");
            Monster.Broodwar.drawCircleMap(StrategyIdea.totalEnemyCneterPosition, 250, Color.Red);
        }
