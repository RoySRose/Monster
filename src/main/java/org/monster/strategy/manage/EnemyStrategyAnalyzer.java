...
public class EnemyStrategyAnalyzer {
    ...
    private static EnemyStrategyAnalyzer instance = new EnemyStrategyAnalyzer();
    ...
    public static EnemyStrategyAnalyzer Instance() {
        return instance;
    }
...
//			System.out.println("expansion explored");
    ...
    public int lastCheckFrame(EnemyStrategyAnalyzer.LastCheckLocation lastCheckLocation) {
        if (lastCheckLocation == EnemyStrategyAnalyzer.LastCheckLocation.BASE) {
            return EnemyStrategyAnalyzer.Instance().lastCheckFrameBase;
        } else if (lastCheckLocation == EnemyStrategyAnalyzer.LastCheckLocation.FIRST_EXPANSION) {
            return EnemyStrategyAnalyzer.Instance().lastCheckFrameFirstExpansion;
        } else if (lastCheckLocation == EnemyStrategyAnalyzer.LastCheckLocation.GAS) {
            return EnemyStrategyAnalyzer.Instance().lastCheckFrameGas;
        } else {
