...
//			vultureratio = StrategyBoard.currentStrategy.ratio.vulture;
//			tankratio = StrategyBoard.currentStrategy.ratio.tank;
//			goliathratio = StrategyBoard.currentStrategy.ratio.goliath;
//			wgt = 1;
//		} else {
...
//	original source ======================
    ...
    public final void select() {
        ...
        if (BuildManager.Instance().buildQueue.getItemCount(UnitType.Terran_Vulture) == 0
            ...
            vultureratio = StrategyBoard.factoryRatio.vulture;
            tankratio = StrategyBoard.factoryRatio.tank;
            goliathratio = StrategyBoard.factoryRatio.goliath;
